...
> **Status: ✅ EXECUTED** — all tasks implemented via TDD; part of the 40-test green suite. (`api`/Plan 2 added Python 3.11; figures reconciled to YA2026; seeded Acme = mid-size SME with e-invoice obligation.)
